...
import { PHASE_COLORS } from "@/lib/workout/generator";
...
type SavedProgram = {
  ...
  program_data: {
    ...
    tips?: string[];
    // New mesocycle data from local generator
    mesocycle?: {
      week1: any;
      week2: any;
      week3: any;
                ...
                <View style={[styles.programCard, { backgroundColor: colors.card }]}>
                  ...
                  >
                    <View style={styles.programInfo}>
                      <View style={styles.programNameRow}>
                        ...
                        {program.program_data.mesocycle && (
                          <View style={[styles.activeBadge, { backgroundColor: `${PHASE_COLORS.accumulation}20` }]}>
                            <Text allowFontScaling={false} style={[styles.activeBadgeText, { color: PHASE_COLORS.accumulation }]}>
                              4-Week
                            </Text>
                          </View>
                        )}
                  ...
                  {expandedProgram === program.id && (
                    <Animated.View entering={FadeIn.duration(200)}>
                      {/* Mesocycle Phase Info (if available) */}
                      {program.program_data.mesocycle && (
                        <View style={[styles.phaseInfoCard, { backgroundColor: colors.cardAlt }]}>
                          <View style={styles.phaseInfoHeader}>
                            <Ionicons name="layers-outline" size={16} color={colors.primary} />
                            <Text allowFontScaling={false} style={[styles.phaseInfoTitle, { color: colors.text }]}>
                              4-Week Mesocycle
                            </Text>
                          </View>
                          <View style={styles.phaseInfoRow}>
                            <View style={[styles.phaseInfoItem, { borderLeftColor: PHASE_COLORS.accumulation }]}>
                              <Text allowFontScaling={false} style={[styles.phaseInfoWeek, { color: colors.textMuted }]}>Week 1-2</Text>
                              <Text allowFontScaling={false} style={[styles.phaseInfoName, { color: PHASE_COLORS.accumulation }]}>Build</Text>
                            </View>
                            <View style={[styles.phaseInfoItem, { borderLeftColor: PHASE_COLORS.intensification }]}>
                              <Text allowFontScaling={false} style={[styles.phaseInfoWeek, { color: colors.textMuted }]}>Week 3</Text>
                              <Text allowFontScaling={false} style={[styles.phaseInfoName, { color: PHASE_COLORS.intensification }]}>Push</Text>
                            </View>
                            <View style={[styles.phaseInfoItem, { borderLeftColor: PHASE_COLORS.deload }]}>
                              <Text allowFontScaling={false} style={[styles.phaseInfoWeek, { color: colors.textMuted }]}>Week 4</Text>
                              <Text allowFontScaling={false} style={[styles.phaseInfoName, { color: PHASE_COLORS.deload }]}>Recover</Text>
                            </View>
                          </View>
                        </View>
                      )}
...
const styles = StyleSheet.create({
  ...
  // Phase Info Card (for mesocycle programs)
  phaseInfoCard: {
    marginHorizontal: 16,
    marginBottom: 12,
    padding: 12,
